...
void    fDisplay(u8 pcode,TypeSubCode_t tScode,TypeValue_t tValue,bool valueDbOrInt,u8 size);
void    fDisplay24(u8 pcode,TypeSubCode_t tScode,TypeValue_t tValue,u8 cntScode,u8 selectPreset);
